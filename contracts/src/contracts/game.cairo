...
trait IGameActions<TContractState> {
    ...
    fn commit_hustler(self: @TContractState, game_id: u128, hash: felt252);
    fn reveal_hustler(self: @TContractState, game_id: u128, hustler: Hustler, salt: felt252);
    fn commit_move(self: @TContractState, game_id: u128, hash: felt252);
...
mod knockout_actions {
    ...
    impl GameActionsImpl of IGameActions<ContractState> {
        ...
        fn commit_hustler(self: @ContractState, game_id: u128, hash: felt252) {}
        fn reveal_hustler(self: @ContractState, game_id: u128, hustler: Hustler, salt: felt252) {}
        fn commit_move(self: @ContractState, game_id: u128, hash: felt252) {}
